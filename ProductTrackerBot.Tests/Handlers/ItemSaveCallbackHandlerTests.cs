...
public class ItemSaveCallbackHandlerTests
{
    ...
    private static Mock<TagCaptureService> CreateTagCaptureServiceMock(Mock<ITelegramBotClient> bot, ILocalizer localizer)
    {
        ...
        var mock = new Mock<TagCaptureService>(bot.Object, new PendingDialogService<TagCaptureDialogState>(), new PendingDialogService<PriceCaptureDialogState>(), tagRepo.Object, localizer);
