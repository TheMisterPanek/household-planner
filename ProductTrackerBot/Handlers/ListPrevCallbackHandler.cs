// <copyright file="ListPrevCallbackHandler.cs" company="PlaceholderCompany">
...
/// <summary>
/// Handles the list previous page navigation callback.
/// </summary>
public class ListPrevCallbackHandler : ICallbackHandler
{
    private readonly ITelegramBotClient botClient;
    private readonly ShoppingListService listService;
    private readonly GroupRepository groupRepository;
    private readonly IHistoryRepository historyRepository;
    private readonly ILogger<ListPrevCallbackHandler> logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="ListPrevCallbackHandler"/> class.
    /// </summary>
    ...
    public ListPrevCallbackHandler(
        ITelegramBotClient botClient,
        ShoppingListService listService,
        GroupRepository groupRepository,
        IHistoryRepository historyRepository,
        ILogger<ListPrevCallbackHandler> logger)
    {
    ...
    /// <inheritdoc/>
    public string CallbackPrefix => "list_prev:";
    ...
    public async Task HandleAsync(CallbackQuery callbackQuery, CancellationToken cancellationToken)
    {
        ...
        var data = callbackQuery.Data["list_prev:".Length..];
        var parts = data.Split(':');
        if (parts.Length != 2 || !long.TryParse(parts[0], out var groupChatId) || !int.TryParse(parts[1], out var pageNumber))
        {
            this.logger.LogWarning("Invalid data in list_prev callback: {Data}", data);
            return;
        }
